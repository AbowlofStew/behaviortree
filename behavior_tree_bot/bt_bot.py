...
def setup_behavior_tree():
    ...
    # If you have 50% of enemy fleet
    attack_sequence_50 = Sequence(name = '50% Attack Sequence')                 # Start of Sequence
    percentage_50_check = Check(have_50_percent)                                # Check 50% of enemy fleet
    do_nothing_action = Action(do_nothing)                                      # Do nothing
    attack_sequence_50.child_nodes = [percentage_50_check, do_nothing_action]   # Add sequence children nodes

    percentage_of_fleet.child_nodes = \
        [attack_sequence_allout, attack_sequence_75, attack_sequence_50]        # Add selector children nodes
